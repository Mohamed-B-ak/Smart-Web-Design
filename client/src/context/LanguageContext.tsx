...
const translations: Record<Language, Record<string, string>> = {
  ...
  ar: {
    ...
    'hero.desc': 'سندس AI هي المنصة السعودية المتكاملة لأتمتة المكالمات الهاتفية وإدارة تجربة العملاء بالذكاء الاصطناعي، حيث تتيح للشركات تشغيل وكلاء صوتيين أذكياء لدعم العملاء وحجز المواعيد تلقائيًا. تدعم المنصة أكثر من 40 لغة وتوفّر +300 تكامل مع أنظمة CRM وواتساب، مع امتثال كامل لأنظمة المملكة.',
    'hero.stat1_val': '+50,000',
