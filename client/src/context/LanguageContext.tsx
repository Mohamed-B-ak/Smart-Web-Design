...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'partner.hero_title': 'Launch Your Own Smart Calls Platform — Under Your Brand',
    'partner.hero_desc': 'The Voice AI market is booming globally — and Saudi Arabia\'s Vision 2030 is accelerating digital transformation. Partner with Sondos to launch your own white-label AI call platform, under your brand, with zero development.',
    'partner.hero_cta1': 'Start Your Partnership',
    'partner.hero_cta2': 'Book a Call',
    'partner.why_title': 'Why Partner With Sondos',
    'partner.why_desc': 'Everything you need to launch and grow your own AI voice platform.',
    'partner.f1_title': '100% Your Brand',
    'partner.f1_desc': 'No trace of Sondos visible to your clients. Your logo, your domain, your colors.',
    'partner.f2_title': 'Dedicated Partner Manager',
    'partner.f2_desc': '1-on-1 support via Slack and WhatsApp. We\'re with you every step.',
    'partner.f3_title': 'Cancel Anytime',
    'partner.f3_desc': 'Flexible monthly billing, no long-term contracts or commitments.',
    'partner.f4_title': 'Unlimited Client Accounts',
    'partner.f4_desc': 'Add as many clients as you want without limits or extra fees.',
    'partner.f5_title': '300+ Ready Integrations',
    'partner.f5_desc': 'HubSpot, Salesforce, GoHighLevel, and hundreds more out of the box.',
    'partner.f6_title': '150+ Countries for Phone Numbers',
    'partner.f6_desc': 'Local and international numbers available in over 150 countries.',
    'partner.f7_title': '100+ Languages',
    'partner.f7_desc': 'With regional dialects and voice cloning for natural conversations.',
    'partner.f8_title': 'Compliance Ready',
    'partner.f8_desc': 'GDPR, TCPA, and Saudi PDPL compliance built into the platform.',
    'partner.opp_title': 'AI Market Is Exploding — Will You Be at the Front?',
    'partner.opp1_title': 'Your Brand, Your Rules',
    'partner.opp1_desc': 'Custom domain, logo, and brand colors. Your clients never see Sondos.',
    'partner.opp2_title': 'Your Effort = Your Profit',
    'partner.opp2_desc': 'Set your own prices, keep 100% of the margin. No revenue sharing.',
    'partner.opp3_title': 'Growing Market',
    'partner.opp3_desc': 'The AI voice market is projected to reach trillions. Position yourself now.',
    ...
    'partner.faq1_a': 'You get a fully white-labeled platform with your own branding, domain, client management dashboard, and access to all Sondos AI features — including voice agents, integrations, phone numbers, and analytics.',
    'partner.faq2_q': 'How long does it take to launch?',
    'partner.faq2_a': 'Most partners launch within 24-48 hours. We handle the technical setup — you focus on acquiring clients.',
    'partner.faq3_q': 'Do I need technical skills?',
    'partner.faq3_a': 'No. The platform is designed for non-technical users. Our partner manager guides you through everything, and the setup is drag-and-drop.',
  ...
  ar: {
    ...
    'partner.hero_title': 'أطلق منصتك الخاصة للمكالمات الذكية — بعلامتك التجارية',
    'partner.hero_desc': 'سوق الذكاء الاصطناعي الصوتي ينمو عالمياً — ورؤية 2030 تسرّع التحول الرقمي في المملكة. شارك مع سندس وأطلق منصة مكالمات ذكية بعلامتك التجارية، بدون أي تطوير.',
    'partner.hero_cta1': 'ابدأ شراكتك',
    'partner.hero_cta2': 'احجز مكالمة',
    'partner.why_title': 'لماذا تشترك مع سندس؟',
    'partner.why_desc': 'كل ما تحتاجه لإطلاق وتنمية منصة صوتية بالذكاء الاصطناعي.',
    ...
    'partner.f7_title': '+100 لغة',
    'partner.f7_desc': 'مع لهجات إقليمية واستنساخ صوتي لمحادثات طبيعية.',
    'partner.f8_title': 'جاهز للامتثال',
    'partner.f8_desc': 'GDPR، TCPA، ونظام حماية البيانات السعودي مدمج في المنصة.',
    'partner.opp_title': 'سوق AI ينفجر — هل ستكون في المقدمة؟',
    'partner.opp1_title': 'علامتك التجارية، قواعدك',
    'partner.opp1_desc': 'نطاق مخصص، شعار، وألوان علامتك. عملاؤك لن يروا سندس أبداً.',
    'partner.opp2_title': 'جهدك = أرباحك',
    'partner.opp2_desc': 'حدد أسعارك بنفسك واحتفظ بـ 100% من الهامش. بدون مشاركة أرباح.',
    'partner.opp3_title': 'سوق متنامي',
    'partner.opp3_desc': 'سوق الصوت الذكي يتجه نحو تريليونات. ضع نفسك الآن في المقدمة.',
    ...
    'partner.faq1_a': 'تحصل على منصة كاملة بعلامتك التجارية مع نطاقك الخاص، لوحة إدارة العملاء، والوصول لجميع ميزات سندس AI — بما في ذلك الوكلاء الصوتيين، التكاملات، أرقام الهاتف، والتحليلات.',
    'partner.faq2_q': 'كم يستغرق الإطلاق؟',
    'partner.faq2_a': 'معظم الشركاء يطلقون خلال 24-48 ساعة. نحن نتولى الإعداد التقني — أنت تركز على اكتساب العملاء.',
    'partner.faq3_q': 'هل أحتاج مهارات تقنية؟',
    'partner.faq3_a': 'لا. المنصة مصممة للمستخدمين غير التقنيين. مدير الشريك يرشدك في كل شيء، والإعداد بالسحب والإفلات.',
    'partner.faq4_q': 'هل يمكنني وضع علامتي التجارية على الوثائق والمواد التسويقية؟',
    'partner.faq4_a': 'نعم. نوفر وثائق وقوالب تسويقية ومواد مبيعات يمكنك تخصيصها بعلامتك التجارية.',
  }
};
