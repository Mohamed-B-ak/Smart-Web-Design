...
export default function LogoCarousel() {
  ...
  return (
    <section className="py-16 overflow-hidden" data-testid="section-logo-carousel">
      <p className="text-center text-[13px] font-medium text-[#6e6e85] uppercase tracking-widest mb-10">
        {t('logo_carousel.title')}
      </p>
      <div className="relative">
        <div className="absolute left-0 top-0 bottom-0 w-32 bg-gradient-to-r from-[#09090f] to-transparent z-10" />
        <div className="absolute right-0 top-0 bottom-0 w-32 bg-gradient-to-l from-[#09090f] to-transparent z-10" />
