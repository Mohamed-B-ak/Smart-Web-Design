          ...
          <div className="text-center max-w-4xl mx-auto space-y-8">
            ...
            >
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/60 border border-primary/20 shadow-sm mb-6 backdrop-blur-sm">
                ...
                <span className="text-sm font-semibold text-primary tracking-wide uppercase">AI-Powered Excellence</span>
              </div>
            ...
            >
              Sondos AI transforms customer interactions with real-time sentiment analysis, intelligent routing, and automated quality assurance.
            </motion.p>
            ...
            >
              <Link href="/contact">
                <Button size="lg" className="h-14 px-8 text-lg rounded-full bg-primary hover:bg-primary/90 shadow-lg shadow-primary/25 hover:shadow-xl hover:-translate-y-0.5 transition-all">
                  Request Demo <ArrowRight className="ml-2 w-5 h-5" />
                </Button>
              </Link>
              <Link href="#features">
                <Button variant="outline" size="lg" className="h-14 px-8 text-lg rounded-full border-2 border-muted hover:bg-muted/50 text-foreground transition-all">
                  Learn More
                </Button>
              </Link>
            </motion.div>
      ...
      <section id="features" className="py-24 bg-secondary/20">
        <div className="container mx-auto px-4 md:px-6">
          <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
            <h2 className="text-primary font-bold text-sm uppercase tracking-wider">Our Technology</h2>
            <h3 className="text-3xl md:text-4xl font-display font-bold text-foreground">
              Built for the Modern Enterprise
            </h3>
            <p className="text-muted-foreground text-lg">
              Our comprehensive suite of AI tools integrates seamlessly with your existing infrastructure to elevate every customer touchpoint.
            </p>
          </div>
        ...
        <div className="container mx-auto px-4 md:px-6 relative z-10 text-center text-white">
          ...
          >
            ...
            <p className="text-lg md:text-xl text-white/80 leading-relaxed">
              Join forward-thinking companies using Sondos AI to deliver exceptional experiences at scale.
            </p>
            <div className="pt-4">
              <Link href="/contact">
                <Button size="lg" className="h-14 px-10 text-lg rounded-full bg-white text-primary hover:bg-white/90 shadow-xl transition-all font-bold">
                  Get Started Now
                </Button>
              </Link>
            </div>
