      ...
      <div className="max-w-[1100px] mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-[#4a3a62] text-lg leading-relaxed">{t('talks.desc')}</p>
          </div>

          <div className="fi bg-white border border-[rgba(90,24,154,0.15)] rounded-2xl p-6 space-y-4">
            {conversation.map((msg, i) => (
              ...
              >
                <div className={`max-w-[85%] ${msg.role === 'customer' ? '' : ''}`}>
                  <p className="text-[11px] text-[#8878a0] mb-1 px-1">
                    {msg.role === 'ai'
                  ...
                  <div
                    className={`px-4 py-3 rounded-2xl text-[14px] leading-relaxed ${
                      msg.role === 'ai'
                        ? 'bg-[rgba(90,24,154,0.12)] text-[#2a2a42] rounded-bl-sm'
