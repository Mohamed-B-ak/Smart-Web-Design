      ...
      <div className="max-w-[900px] mx-auto text-center">
        <div className="fi bg-gradient-to-br from-[rgba(124,92,252,0.15)] to-[rgba(155,138,251,0.05)] border border-[rgba(124,92,252,0.2)] rounded-3xl p-12 md:p-16 relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <p className="text-[#a1a1b5] text-lg max-w-[500px] mx-auto mb-9">{t('cta.desc')}</p>
            <div className="flex items-center justify-center gap-4 flex-wrap">
              ...
              <a
                href="#"
                className="inline-flex items-center gap-2 px-8 py-3.5 text-[15px] font-semibold text-[#f5f5f7] border border-[rgba(255,255,255,0.15)] rounded-full hover:bg-[rgba(255,255,255,0.08)] transition-all"
