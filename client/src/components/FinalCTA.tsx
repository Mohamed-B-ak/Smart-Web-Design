...
export default function FinalCTA() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-10 right-[15%] w-32 h-32 rounded-full opacity-15 float-gentle" style={{ background: 'radial-gradient(circle, rgba(90,24,154,0.2), transparent 70%)' }} />
      <div className="absolute bottom-10 left-[10%] w-24 h-24 rounded-full opacity-10 float-slow" style={{ background: 'radial-gradient(circle, rgba(157,78,221,0.2), transparent 70%)', animationDelay: '2s' }} />

      <div className="relative z-10 mx-auto max-w-3xl px-6 text-center">
        <div className="inline-flex items-center gap-2 mb-6">
          <Sparkles className="w-5 h-5 text-[#9d4edd]" style={{ animation: 'pulseGlow 2s infinite' }} />
        </div>
